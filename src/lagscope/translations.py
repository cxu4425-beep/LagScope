...
JA: dict = {
    ...
    "label.audio": "ヘッドホン",
    "label.server": "サーバー",
    "health.title": "いま測れていないもの",
    "health.since": "{when} から",
    "health.wifi": "無線の情報",
    "health.wifi.cost": "レポートはこの端末を有線として扱い、無線ネットワークや電波の強弱を比べられません。",
    "health.display": "リフレッシュレート",
    "health.display.cost": "表示遅延は実測ではなく 60 Hz と仮定して計算しています。合計のその部分は高すぎるか低すぎる可能性があります。",
    "health.icmp": "ICMP (ping)",
    "health.icmp.cost": "代わりに TCP ハンドシェイクで測るため、ping より数ミリ秒高く出ます。",
    "health.audio": "音声出力",
    "health.audio.cost": "Bluetooth 遅延の測定ができません。",
    "health.window": "ウィンドウ追従",
    "health.window.cost": "オーバーレイがウィンドウを追えず、画面の隅に固定されます。",
    "health.all_working": "すべて正常に測れています。",
...
KO: dict = {
    ...
    "label.audio": "헤드폰",
    "label.server": "서버",
    "health.title": "지금 측정할 수 없는 것",
    "health.since": "{when}부터",
    "health.wifi": "무선 정보",
    "health.wifi.cost": "보고서는 이 기기를 유선으로 표시하며, 무선 네트워크나 신호 강약을 비교할 수 없습니다.",
    "health.display": "화면 주사율",
    "health.display.cost": "화면 지연은 측정값이 아니라 60Hz 가정으로 계산합니다. 총합의 그 부분이 높거나 낮을 수 있습니다.",
    "health.icmp": "ICMP (ping)",
    "health.icmp.cost": "대신 TCP 핸드셰이크로 측정하므로 보통 ping보다 몇 밀리초 높습니다.",
    "health.audio": "오디오 출력",
    "health.audio.cost": "블루투스 지연 측정을 실행할 수 없습니다.",
    "health.window": "창 따라가기",
    "health.window.cost": "오버레이가 창을 따라가지 못하고 화면 구석에 고정됩니다.",
    "health.all_working": "모든 측정이 정상입니다.",
